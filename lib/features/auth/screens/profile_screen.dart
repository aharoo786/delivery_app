        ...
        child: Column(
          ...
          children: [
            ...
            Center(
              child: Column(
                children: [
                  ...
                  _isLoggedIn ? Consumer<ProfileProvider>(builder: (context, profileProvider, child) {
                    return   profileProvider.userInfoModel==null?SizedBox.shrink(): Column(
                      children: [
                       // ProfileHeaderWidget(),
                        Padding(
            ...
            AccountOption(
              ...
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (ctx){
                  return OrderListScreen(showAppBar: true,);
                }));
              },
            ),
            AccountOption(
              ...
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (ctx){
                  return WalletScreen(showAppBar: true,);
                }));
              },
            ),AccountOption(
              isImg: true,
              ...
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (ctx){
                  return AddressListScreen(showAppBar: true,);
                }));
              },
            ),
            AccountOption(
            ...
            AccountOption(
              ...
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (ctx){
                  return HtmlViewerScreen(htmlType: HtmlType.aboutUs);
                }));
              },
            ),
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: ListTile(
        ...
        leading: isImg?Image.asset(svgPath!,color: Colors.black,height: 20,width: 20,):  isSvg
        ...
        trailing: Icon(Icons.arrow_forward_ios,size: 16,color: Colors.black,) ?? const SizedBox.shrink(),
      ),
    );
  }
}
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      trailing: Transform.scale(
        ...
        child: Switch(
          value: value,
          activeTrackColor: Color(0xff40C979),
