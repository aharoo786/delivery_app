...
class _ReferAndEarnScreenState extends State<ReferAndEarnScreen> {
  ...
  void initState() {
    ...
    var value =  Provider.of<ProfileProvider>(context, listen: false).userInfoModel;
              ...
              ? Consumer<ProfileProvider>(builder: (context, profileProvider, _) {
                  return profileProvider.userInfoModel != null
                      ? Center(
                              ...
                              children: [
                                Container(
                                  constraints: ResponsiveHelper.isDesktop(context)
                                      ...
                                      : BoxConstraints(
                                          maxHeight: ResponsiveHelper.isDesktop(context) ? MediaQuery.of(context).size.height : MediaQuery.of(context).size.height * 0.7),
                          ...
                          expandableContent: ResponsiveHelper.isDesktop(context) ? const SizedBox() : ReferHintWidget(hintList: hintList),
                        ))
