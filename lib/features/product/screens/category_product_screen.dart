  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: (ResponsiveHelper.isDesktop(context)
          ...
          : const CustomAppBarWidget(title: '', isCenter: false, fromCategory: false)) as PreferredSizeWidget?,
                                        ...
                                        child: InkWell(
                                          ...
                                          child: Container(
                                            ...
                                            decoration: BoxDecoration(
                                                color: categoryProvider.selectedCategoryIndex == -1 ? Colors.black : ColorResources.getGreyColor(context),
                                          ...
                                          itemBuilder: (BuildContext context, int index) {
                                            return InkWell(
                                              ...
                                              child: Container(
                                                ...
                                                margin: const EdgeInsets.only(right: Dimensions.paddingSizeSmall),
                                                decoration: BoxDecoration(
                                                    color: categoryProvider.selectedCategoryIndex == index ? Colors.black : ColorResources.getGreyColor(context),
                                                    borderRadius: BorderRadius.circular(7)),
                                                child: Text(
