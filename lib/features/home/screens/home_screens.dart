    ...
    return RefreshIndicator(
      ...
      child: Scaffold(
        ...
        body: CustomScrollView(controller: scrollController, slivers: [
                    ...
                    Selector<SplashProvider, ConfigModel?>(
                        ...
                        builder: (context, configModel, _) {
                          return (configModel?.featuredProductStatus ?? false)
                              ? Column(children: [
                                  TitleWidget(
                                      title: getTranslated(ProductType.featuredItem, context),
                                      onTap: () {
                                        Navigator.pushNamed(context, RouteHelper.getHomeItemRoute(ProductType.featuredItem));
                                      }),
                                  HomeItemWidget(productList: productProvider.featuredProductModel?.products, isFeaturedItem: false),
                                ])
                              : const SizedBox();
                        }),
                    ...
                    Selector<SplashProvider, ConfigModel?>(
                        ...
                        builder: (context, configModel, _) {
                          return (configModel?.mostReviewedProductStatus ?? false)
                              ? Column(children: [
                                  TitleWidget(
                                      title: getTranslated(ProductType.mostReviewed, context),
                                      onTap: () {
          ...
          if (ResponsiveHelper.isWeb()) ...[const FooterWebWidget(footerType: FooterType.sliver)],
        ]),
      ),
    );
  }
