...
class _SplashScreenState extends State<SplashScreen> {
  ...
  void _route() {
    ...
    splashProvider
        .initConfig(source: DataSourceEnum.local)
        .then((configModel) async {
  ...
  void _checkConnectivity() {
    ...
    subscription = Connectivity()
      ...
      if ((isFirst && !isConnected) || !isFirst && context.mounted) {
        ...
        if (isConnected &&
            ModalRoute.of(context)?.settings.name == RouteHelper.splash) {
          _route();
        }
      }
      isFirst = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: ColorResources.splashColor,
