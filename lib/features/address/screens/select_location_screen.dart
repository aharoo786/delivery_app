  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: (ResponsiveHelper.isDesktop(context)
          ...
          : CustomAppBarWidget(title: getTranslated('select_delivery_address', context), isCenter: true)) as PreferredSizeWidget?,
      body: Center(
        child: SizedBox(
          width: 1170,
          child: Consumer<LocationProvider>(
            builder: (context, locationProvider, child) => Stack(
              ...
              children: [
                  ...
                  onMapCreated: (GoogleMapController controller) {
                    Future.delayed(const Duration(milliseconds: 800)).then((value) {
                      ...
                      _controller!.moveCamera(CameraUpdate.newCameraPosition(CameraPosition(
                          target: locationProvider.pickPosition.longitude.toInt() == 0 && locationProvider.pickPosition.latitude.toInt() == 0
                              ? _initialPosition
                              : LatLng(
                ...
                locationProvider.pickAddress != null ? SearchBarView(onTap: () => _openSearchDialog(context, _controller)) : const SizedBox.shrink(),
                Positioned(
                  bottom: 0,
                  right: 0,
                  left: 0,
                          ...
                          child: CustomButtonWidget(
                            ...
                            onPressed: locationProvider.loading
                                ...
                                : () {
                                    ...
                                    print(
                                        "----------(Select Location)-------------------------Address: ${locationProvider.address} and PickAddress ${locationProvider.pickAddress}");
                                    ...
                                    if (widget.googleMapController != null) {
                                      ...
                                      if (locationProvider.mapController != null) {
                                        Future.delayed(const Duration(milliseconds: 800)).then((value) {
                                          locationProvider.mapController!.animateCamera(CameraUpdate.newCameraPosition(CameraPosition(
                                              target: LatLng(
                ...
                locationProvider.loading ? Center(child: CustomLoaderWidget(color: Theme.of(context).primaryColor)) : const SizedBox(),
              ],
            ),
          ),
        ),
          ...
          return InkWell(
            ...
            child: Container(
              ...
              child: Row(children: [
                Expanded(
                    child: Text(
                  pickAddress != null && pickAddress.isNotEmpty ? pickAddress : getTranslated('search_here', context),
                  maxLines: 1,
